...
class AdvanceOptions(BaseOptions):
    def initialize(self, parser, flag):
        ...
        parser.add_argument('--train_path', required=False, help='path to the training dataset')
        parser.add_argument('--test_path', required=False, help='path to the testing dataset')
        self.isTrain = flag
        return parser
